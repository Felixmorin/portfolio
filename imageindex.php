...
<div class="container">
    ...
    <form action="/Portfolio_copie/imageUpload.php" class="form-image-upload" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <br/>
                <button type="submit" name="uploadImage" class="btn btn-success">Upload</button>
